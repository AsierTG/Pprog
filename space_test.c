...
int main(int argc, char **argv)
{
  ...
  if (all || test == 35)
    test6_space_set_gdesc();

  if (all || test == 35)
    test7_space_set_gdesc();
...
void test1_space_get_object()
{
  Space *s;
  s = space_create(1);
  PRINT_TEST_RESULT(space_have_object(s,3) == FALSE);
  space_destroy(s);
}
...
void test1_space_get_gdesc()
{
  Space *s;
  s = space_create(25);
  space_set_gdesc(s, "123456789", 0);
  PRINT_TEST_RESULT(strcmp(space_get_gdesc(s,0), "123456789") == 0);
  space_destroy(s);
}
...
void test1_space_set_gdesc()
{
  Space *s;
  s = space_create(25);
  PRINT_TEST_RESULT(space_set_gdesc(s, "123456789", 0) == OK);
  space_destroy(s);
}
...
{
  Space *s = NULL;
  PRINT_TEST_RESULT(space_set_gdesc(s, "123456789", 0) == ERROR);
}
...
void test4_space_set_gdesc()
{
  Space *s;
  s = space_create(25);
  PRINT_TEST_RESULT(space_set_gdesc(s, "123456789", -1) == ERROR);
  space_destroy(s);
}

/*Pos superior al límite */
void test5_space_set_gdesc()
{
  Space *s;
  s = space_create(25);
  PRINT_TEST_RESULT(space_set_gdesc(s, "123456789", 10) == ERROR);
  space_destroy(s);
}
...
/* String largo*/
void test7_space_set_gdesc()
{
  Space *s;
  s = space_create(25);
  PRINT_TEST_RESULT(space_set_gdesc(s, "123456789123", 2) == ERROR);
  space_destroy(s);
}
